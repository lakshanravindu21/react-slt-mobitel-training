    ...
    <div className="min-h-screen flex flex-col bg-[#f9fbfc] text-[#333]">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6 md:p-10">
          <div className="bg-white p-6 md:p-10 rounded-2xl shadow-lg w-full max-w-6xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-[#333]">Accepted CVs</h2>
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead className="bg-[#004a99] text-white uppercase">
                  <tr>
